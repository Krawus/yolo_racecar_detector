...
int Engine::build_engine(std::string onnx_path, std::string engine_path, OptimDim dyn_dim_profile) {
...
int Engine::init(std::string engine_name) {
...
std::vector<BBoxInfo> Engine::run(cv::Mat left_sl, int orig_image_h, int orig_image_w, float thres, float nms) {
